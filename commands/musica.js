exports.run = async (discord, fs, config, keys, client, message, args, command, loggingChannel, debuggingChannel, resources) => {
    ...
    try {
        let helpEmbed1 = new discord.MessageEmbed()
            ...
            .addField(`⏭ ${config.prefix}playskip (URL de YouTube | término)`, `Reproduce la canción o playlist inmediatamente (a pesar de la cola)`, true)
            .addField(`➡ ${config.prefix}skip (cantidad opcional | all)`, `Omite la canción actual (o más si se especifica cantidad)`, true)
            .addField(`❎ ${config.prefix}remove (posición | all)`, `Elimina una canción de la cola de reproducción`, true)
