exports.run = (discord, client, message, args, command) => {
    ...
    try {
        let helpEmbed = new discord.MessageEmbed()
            ...
            .addField(':three: No abuses de las menciones:', 'No está permitido excederse utilizando las menciones a personas, a __roles__, o a `@everyone` y `@here`. _Las menciones abusivas pueden ser realmente molestas y pueden llevar a los miembros a silenciar el servidor._')
