            ...
            if (message.mentions.channels.first()) {
                ...
                async function changeLoggingChannel() {
                    try {
                        ...
                        config.debugging = channelMention;
                        ...
                        let completedEmbed = new discord.RichEmbed()
                            ...
                            .setDescription('Cambiaste el canal de depuración a ' + args[0]);
                        ...
                        let loggingEmbed = new discord.RichEmbed()
                            ...
                            .setTitle('📑 Auditoría')
                            .setDescription(message.author.username + ' cambió el canal de depuración a ' + args[0]);
