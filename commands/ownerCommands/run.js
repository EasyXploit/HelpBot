exports.run = async (discord, fs, client, message, args, command) => {
    ...
    try {
        let noCorrectSyntaxEmbed = new discord.MessageEmbed()
            ...
            .setDescription(`${client.emotes.redTick} La sintaxis de este comando es \`${client.config.prefixes.ownerPrefix}template (plantilla)\``);
        ...
        if (args[0] === `informacion`) {
            ...
            const cfg = require('../../configs/guild.json');
            ...
            let successEmbed = new discord.MessageEmbed()
                ...
                .setDescription(`${client.emotes.greenTick} ¡Listo!`);
            ...
            let embed = new discord.MessageEmbed()
                ...
                .setAuthor(`Presenta tu oposición a moderador (LATAM)`, client.homeGuild.iconURL())
            ...
            let startingEmbed = new discord.MessageEmbed()
                ...
                .setTitle(`${client.emotes.grayTick} Encuadrando stats`)
            ...
            let interval = setInterval(async function() {
                ...
                if (index === IDs.length) {
                    ...
                    let finishedEmbed = new discord.MessageEmbed()
                        .setColor(client.colors.green2)
                        .setTitle(`${client.emotes.greenTick} Stats encuadradas`)
            ...
            /*let startingEmbed = new discord.MessageEmbed()
                .setColor(client.colors.gray)
                .setTitle(`${client.emotes.grayTick} Ajustando stats`)
            ...
            let interval = setInterval(async function() {
                ...
                if (index === IDs.length) {
                    ...
                    let finishedEmbed = new discord.MessageEmbed()
                        .setColor(client.colors.green2)
                        .setTitle(`${client.emotes.greenTick} Stats ajustadas`)
            ...
            let noArgsEmbed = new discord.MessageEmbed()
                .setColor(client.colors.red)
                .setDescription(`${client.emotes.redTick} No has especificado una plantilla válida`);
