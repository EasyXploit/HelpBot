exports.run = (discord, fs, client, message, args, command) => {
    ...
    try {
        let helpEmbed = new discord.MessageEmbed()
            ...
            .addField(`${client.emotes.translate} ${client.config.prefixes.mainPrefix}translate (idioma orígen) (idioma destino) (texto a traducir)`, `Traduce un texto proporcionado (usa códigos de idioma. P. ej: _en_)`)
            ...
            .addField(`${client.emotes.coin} ${client.config.prefixes.mainPrefix}moneda`, `Lanzará una moneda.`)
