exports.run = (discord, fs, config, keys, client, message, args, command, loggingChannel, debuggingChannel, resources) => {
    ...
    try {
        let helpEmbed = new discord.MessageEmbed()
            ...
            .addField(`${resources.translate} ${config.prefix}translate (idioma orígen) (idioma destino) (texto a traducir)`, `Traduce un texto proporcionado (usa códigos de idioma. P. ej: _en_)`)
            .addField(`👦 ${config.prefix}avatar (@usuario)`,  `Muestra tu avatar o el de cualquier miembro.`)
