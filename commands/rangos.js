exports.run = async (discord, fs, config, keys, bot, message, args, command, loggingChannel, debuggingChannel, resources) => {
    ...
    try {
        let helpEmbed1 = new discord.MessageEmbed ()
            ...
            .addField(`${resources.chevron} Nivel 0 ‣ NOVATOS`, 'Es el primer rol que recibes al unirte a la comunidad.')
            .addField(`${resources.chevron5} Nivel 5 ‣ INICIADOS`, `Permite usar emojis externos ${resources.nitro} y acceder a sorteos públicos.`)
            .addField(`${resources.chevron15} Nivel 10 ‣ VETERANOS`, 'Permite **adjuntar archivos** y **cambiar tu propio apodo**.')
            .addField(`${resources.chevron18} Nivel 15 ‣ EXPERTOS`, 'Te permite **mencionar a todos** y **controlar la música**.')
