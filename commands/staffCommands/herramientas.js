exports.run = (discord, fs, config, token, bot, message, args, command, roles, loggingChannel) => {
    ...
    let successEmbed = new discord.RichEmbed()
        ...
        .addField('🛡 !ban <@usuario> [motivo]', 'Banea a un usuario :key:', true)
        .addField('🕑 !tempban <@usuario> [motivo]', 'Banea a un usuario temporalmente :key:', true)
        .addField('🔄 !kick <@usuario> [motivo]', 'Expulsa a un usuario :key:', true)
        .addField('⏱ !tempkick <@usuario> [motivo]', 'Expulsa a un usuario temporalmente :key:', true)
        .addField('🔇 !mute <@usuario> [motivo]', 'Silencia a un usuario :key:', true)
        .addField('🔈 !tempmute <@usuario> [motivo]', 'Silencia a un usuario temporalmente', true)
        .addField('🔊 !unmute <@usuario>', 'Des-silencia a un usuario :key:', true)
        .addField('🔔 !warn <@usuario> [advertencia]', 'Advierte a un usuario', true)
