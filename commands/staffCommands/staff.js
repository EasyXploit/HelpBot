exports.run = async (discord, fs, config, keys, bot, message, args, command, loggingChannel, debuggingChannel, resources) => {
    ...
    try {
        ...
        let helpEmbed = new discord.RichEmbed()
            ...
            .addField(':stop_button: ' + config.staffPrefix + 'stop', 'Detiene a ' + bot.user.username + resources.chevron10, true)
            .addField('🙍 ' + config.staffPrefix + 'userinfo (@usuario | id | nada)', 'Muestra información acerca del usuario mencionado' + resources.beta, true)
            ...
            .addField('🔇 ' + config.staffPrefix + 'mute (@usuario | id) (motivo)', 'Silencia a un usuario' + resources.chevron10, true)
            .addField('🔈 ' + config.staffPrefix + 'tempmute (@usuario | id) (xS | xM | xH | xD) (motivo)', 'Silencia a un usuario de forma temporal' + resources.beta, true)
            .addField('🔊 ' + config.staffPrefix + 'unmute (@usuario | id) (motivo)', 'Des-silencia a un usuario' + resources.chevron10, true)
            .addField('⛔ ' + config.staffPrefix + 'kick (@usuario | id)) (motivo)', 'Expulsa a un usuario' + resources.chevron10, true)
            .addField(':hammer: ' + config.staffPrefix + 'ban (@usuario | id) (motivo)', 'Banea a un usuario' + resources.chevron10, true)
            ...
            .addField(resources.GreenTick + ' ' + config.staffPrefix + 'unban (id) (motivo)', 'Desbanea a un usuario' + resources.chevron10, true)
