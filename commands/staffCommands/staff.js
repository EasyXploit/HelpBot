exports.run = (discord, fs, config, keys, bot, message, args, command, roles, loggingChannel) => {
    ...
    let successEmbed = new discord.RichEmbed()
        ...
        .addField('🔈 ' + config.staffPrefix + '&silenciar (@mención/id) (motivo)', 'Silencia a un usuario :key:', true)
        .addField('🔊 ' + config.staffPrefix + '&dessilenciar (@mención/id) (motivo)', 'Des-silencia a un usuario :key:', true)
