...
module.exports = async (logType, contentType, content, attachments) => {
    ...
    try {
        ...
        const missingPermissions = await client.functions.utilities.missingPermissions(logChannel, logChannel.guild.me, ['SEND_MESSAGES', 'EMBED_LINKS', 'ATTACH_FILES'], true);
