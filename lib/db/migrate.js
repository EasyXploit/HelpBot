...
export default async (dbOptions, direction, targetMigration) => {
    ...
    try {
        ...
        migrate.config.set({
            mongodb: {
                url : `mongodb://${process.env.DB_TARGET}:${process.env.DB_PORT}/${process.env.DB_NAME}`,
                options: dbOptions
            },
        ...
        if (direction === 'up' && pendingMigrations.length === 0) {
            ...
            pendingMigrations.forEach((migration) => {
                ...
                // Shows the name of the migration through the console
        ...
        // Indicates through the console that migrations have been completed
