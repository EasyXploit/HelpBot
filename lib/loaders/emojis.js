//Exporta una función para cargar los emojis de sistema en una guild de servicio
export async function loadEmojis() {
    ...
    try {
        ...
        for (let index = 0; index < localEmojis.length; index++) {
            ...
            if (!remoteEmojiNames.includes(emojiName)) await client.serviceGuild.emojis.create({ name: `./assets/emojis/${emojiName}.png`, file: emojiName });
        };
