...
export async function loadTimedMessages() {
    ...
    async function sendMessage(messageConfig, channel) {
        ...
        const missingPermissions = await client.functions.utils.missingPermissions(channel, channel.guild.me, ['SEND_MESSAGES', 'EMBED_LINKS', 'ATTACH_FILES', 'READ_MESSAGE_HISTORY'], true);
