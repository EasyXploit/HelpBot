...
export default async (logType, contentType, content, attachments) => {
    ...
    try {
        ...
        const missingPermissions = await client.functions.utils.missingPermissions(logChannel, logChannel.guild.members.me, ['SEND_MESSAGES', 'EMBED_LINKS', 'ATTACH_FILES'], true);
