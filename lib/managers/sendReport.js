...
export default async (interaction, modalInteraction, reportReason, reportedMember) => {
    ...
    try {
        ...
        if (!await client.functions.db.getConfig('system.modules.memberReports')) {
            ...
            return await (modalInteraction ? modalInteraction : interaction).reply({ embeds: [ new discord.MessageEmbed()
        ...
        let reportEmbed = new discord.MessageEmbed()
            ...
            .setAuthor({ name: `${await client.functions.utils.parseLocale(locale.reportEmbed.author, { memberTag: interaction.member.user.tag })}:`, iconURL: interaction.member.user.displayAvatarURL({dynamic: true}) })
            .setFields([
        ...
        if (deliveryStatus) {
            ...
            await (modalInteraction ? modalInteraction : interaction).reply({ embeds: [ new discord.MessageEmbed()
