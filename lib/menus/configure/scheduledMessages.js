...
export default async (beforeError) => {
    ...
    try {
        ...
        async function drawMenu() {
            ...
            const currentModuleStatus = await client.functions.db.getConfig('system.modules.scheduledMessages');
            ...
            global.currentPrompt.then(async (result) => {
                ...
                switch (result) {
                    ...
                    case 'changeModuleStatus':
                        ...
                        await client.functions.db.setConfig('system.modules.scheduledMessages', !currentModuleStatus);
