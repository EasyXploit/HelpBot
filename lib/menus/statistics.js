...
export default async (beforeError) => {
    ...
    try {
        ...
        const timedMessagesData = await client.functions.db.getConfig('timedMessages.configuredMessages');
        ...
        databasesTable.push(
            ...
            [ locale.databasesInfo.totalTimedMessages, timedMessagesData ? timedMessagesData.length : 0 ]
        );
        ...
        global.currentPrompt.then(async (result) => {
            ...
            switch (result) {
                ...
                case 'refresh':
                    ...
                    // Shows the statistics menu again
