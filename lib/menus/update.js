    ...
    try {
        ...
        try {
            ...
            const updateConfiguration = {
                ...
                fromReleases: false,                                                            // Uses the releases based on the selected branch (exclucing pre-releases)
            ...
            // Logs a message indicating the configuration that will be used
            logger.debug(`Using the following configuration for the updater: ${JSON.stringify(updateConfiguration, null, 4)}`);
            ...
            // Logs a message indicating the update status
            logger.debug(`The bot is ${updateStatus.upToDate ? 'up to date' : 'not up to date'} (current version: ${updateStatus.currentVersion}, remote version: ${updateStatus.remoteVersion})`);
            ...
            if (!updateStatus.upToDate) {
                ...
                logger.debug(`The bot is updated to the latest version (current version: ${updateStatus.currentVersion}, remote version: ${updateStatus.remoteVersion})`);
            };
