...
export default async (member, reason, action, moderator, message, interaction, channel, filteredURL) => {
    ...
    try {
        ...
        if (channel.type !== 'DM') {
            ...
            const missingExtEmojisPermissions = interaction || channel.type !== 'DM' ? await client.functions.utils.missingPermissions(channel, client.baseGuild.members.me, ['UseExternalEmojis']) : false;
