...
export default async (member, reason, action, moderator, message, interaction, channel, filteredURL) => {
    ...
    try {
        ...
        async function timeout(duration) {
            ...
            const missingPermission = await client.functions.utils.missingPermissions(null, client.baseGuild.me, ['ModerateMembers']);
        ...
        async function kick() {
            ...
            const missingPermission = await client.functions.utils.missingPermissions(null, client.baseGuild.me, ['KickMembers']);
        ...
        async function ban(duration) {
            ...
            const missingPermission = await client.functions.utils.missingPermissions(null, client.baseGuild.me, ['BanMembers']);
        ...
        if (channel.type !== 'DM') {
            ...
            const missingExtEmojisPermissions = interaction || channel.type !== 'DM' ? await client.functions.utils.missingPermissions(channel, client.baseGuild.me, ['UseExternalEmojis']) : false;
