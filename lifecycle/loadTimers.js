module.exports = async () => {
    ...
    async function sendMessage(messageConfig, channel) {
        ...
        const timedMessage = await client.functions.utilities.assembleMessage({
    ...
    for (let configuredMessage of configuredMessages) {
        ...
        const channel = await client.functions.utilities.fetch('channel', configuredMessage.channelId);
