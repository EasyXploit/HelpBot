exports.run = async (client, guild) => {
    ...
    try {
        ...
        await require('./systemLoad.js').run(client, client.locale.utils.lifecycle.systemLoad);
        ...
        console.error(`${new Date().toLocaleString()} 》${client.locale.utils.lifecycle.newGuild.error}:`, error.stack);
    };
};
